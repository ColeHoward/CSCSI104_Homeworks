...
{
    Product* parsed = new Book("book", prodName_, price_, qty_, author_, isbn_);
    return parsed;
}
...
{
Product* parsed = new Clothing("clothing", prodName_, price_, qty_, size_,
                                                                    brand_);
    return parsed;
}
...
{
    Product* parsed = new Movie("movie", prodName_, price_, qty_, genre_, 
                                                                  rating_);
    return parsed; 
}
